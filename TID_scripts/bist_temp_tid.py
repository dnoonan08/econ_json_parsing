...
if __name__ == '__main__':
    ...
    plots = create_plot_path(args.path+ '/' + 'bist_temp_vs_tid_plots-%s'%args.chip)
    ...
    for j in range(6):
        for i in range(5):
            if i == 0:
                ...
                axs2.plot(temperatures[1.2]["mradDose"], temperatures[1.2]["temperature"], color ='orange', label='1.2 volt', alpha=1.0)
                ...
                axs2.plot(temperatures[1.08]["mradDose"], temperatures[1.08]["temperature"], color ='green', label='1.08 volt', alpha=1.0)
                axs2.set_ylabel("Temperature")
                #axs2.patch.set_facecolor('red')
                axs2.patch.set_alpha(0.1)
                axs2.set_ylim(-15,30)
